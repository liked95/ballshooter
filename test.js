...
class Enemy extends Projectile {
    constructor(x, y, radius, color, vel) {
        ...
        this.lineWidth = 1;
        this.speedRatio = enemySpeedCoefficient;
    }
    ...
    update() {
        ...
        if (this.type === 'linear') {
            this.x += this.vel.x * this.speedRatio;
            this.y += this.vel.y * this.speedRatio;
            ...
            this.radians += 0.05 * this.speedRatio;
            this.center.x += this.vel.x * this.speedRatio;
            this.center.y += this.vel.y * this.speedRatio;
            ...
            if (buff.type === 'powerup') {
                ...
                setTimeout(() => {
                    ...
                    if(buffFound) {
                        buffs.splice(buffIndex, 1)
                        // Slow enemy
                        enemySpeedCoefficient = 0.3;
                    }
                }, 0);

                setTimeout(() => {
                    // enemySpeedCoefficient = 1.1
                }, 3000);
            } 
